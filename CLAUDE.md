...
- New source strategies: add a parser module (`catalog/<name>.py`), register in the `_SUBFOLDER_PARSERS` dict or add a dispatch branch in `_process_source` inside `cli.py`.
